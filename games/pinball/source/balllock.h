...
class BallLock {
    ...
    private:
        ...
        vector<float> m_lowerLock1 = {229.5, 251.2, 229.0, 252.5, 229.2, 333.0, 229.5, 413.5, 238.5, 413.5, 247.5, 413.5, 247.5, 332.0, 247.5, 250.5, 238.7, 250.2, 230.0, 249.9, 229.5, 251.2};
