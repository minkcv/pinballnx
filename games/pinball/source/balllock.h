...
class BallLock {
    ...
    private:
        ...
        vector<float> m_lowerLock1 = {194.3, 424.2, 193.3, 425.5, 192.6, 428.3, 191.9, 431.2, 193.1, 432.6, 194.2, 434.0, 213.4, 434.0, 232.6, 434.0, 233.8, 432.8, 235.0, 431.6, 235.0, 428.5, 235.0, 425.4, 233.8, 424.2, 232.6, 423.0, 213.9, 423.0, 195.2, 423.0, 194.3, 424.2};
