...
class Ramp {
    ...
    private:
        ...
        vector<float> m_backdoorUp = {1011.0, 643.5, 981.5, 660.0, 979.8, 660.0, 978.0, 660.0, 978.0, 662.2, 978.0, 664.5, 985.0, 682.4, 992.0, 700.4, 994.0, 701.0, 996.1, 701.0, 999.8, 699.1, 1003.6, 697.2, 1007.5, 696.5, 1011.5, 695.7, 1014.0, 694.5, 1016.5, 693.3, 1022.0, 691.6, 1027.5, 689.8, 1034.1, 685.5, 1040.6, 681.2, 1045.0, 679.0, 1049.4, 676.8, 1054.4, 672.0, 1059.5, 667.3, 1062.8, 665.6, 1066.0, 663.9, 1066.0, 661.8, 1066.0, 659.6, 1055.4, 643.3, 1044.8, 627.0, 1042.7, 627.0, 1040.5, 627.0, 1011.0, 643.5};
        // Access this vector by index of rampID to get the collision shape for that ramp
        vector<vector<float>> m_rampShapes = {
            m_launchTubeExitSensor, m_ramp1, m_ramp1up2, m_ramp1Down, m_hole1, m_ramp2, m_ramp2up2, m_ramp2Down, m_hole2, m_ramp3, m_ramp3Down, m_ramp3up2, m_ramp1DownMid, m_backdoorDown, m_backdoorUp
        };
};
