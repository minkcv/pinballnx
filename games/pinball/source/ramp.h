...
class Ramp {
    ...
    private:
        ...
        vector<float> m_newballEntrance4 = {664.5, 425.3, 656.0, 436.7, 656.0, 437.7, 656.0, 438.8, 659.5, 441.5, 663.1, 444.2, 664.4, 443.7, 665.8, 443.2, 673.5, 432.4, 681.3, 421.6, 681.7, 419.9, 682.2, 418.3, 679.4, 416.1, 676.7, 414.0, 674.9, 414.0, 673.0, 414.0, 664.5, 425.3};
        ...
        vector<vector<float>> m_rampShapes = {
            m_ramp1, m_ramp1up2, m_ramp1Down, m_hole1, m_ramp2, m_ramp2up2, m_ramp2Down, m_hole2, m_ramp3, m_ramp3Down, m_ramp3up2, m_backdoorDown, m_tunnelDown, m_newballEntrance1, m_newballEntrance2, m_newballEntrance3, m_newballEntrance4, m_underLayerUp
        };
};
