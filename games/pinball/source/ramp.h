...
class Ramp {
    ...
    private:
        ...
        vector<float> m_ramp1DownMid = {937.8, 344.6, 929.0, 352.2, 929.0, 353.4, 929.0, 354.5, 939.1, 366.8, 949.1, 379.0, 950.3, 379.0, 951.5, 379.0, 962.8, 370.0, 974.0, 360.9, 974.0, 359.6, 974.0, 358.3, 965.3, 350.5, 956.5, 342.6, 954.0, 340.4, 951.5, 338.1, 949.0, 337.5, 946.5, 336.9, 937.8, 344.6};
