...
class Ramp {
    ...
    private:
        ...
        vector<float> m_ramp1DownMid = {687.3, 298.0, 676.5, 311.0, 676.2, 312.4, 675.9, 313.7, 684.7, 320.9, 693.4, 328.0, 695.6, 328.0, 697.8, 328.0, 709.2, 315.0, 720.5, 301.9, 720.8, 300.6, 721.1, 299.2, 710.9, 292.1, 700.6, 285.0, 699.4, 285.0, 698.1, 285.0, 687.3, 298.0};
