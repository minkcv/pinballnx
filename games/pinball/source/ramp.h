...
class Ramp {
    ...
    private:
        ...
        vector<float> m_ramp1DownMid = {904.8, 372.7, 902.2, 375.5, 895.8, 380.0, 889.5, 384.4, 884.8, 388.4, 880.0, 392.3, 880.0, 394.6, 880.0, 396.8, 892.3, 406.4, 904.5, 416.0, 906.5, 416.0, 908.5, 416.0, 915.5, 410.4, 922.5, 404.9, 926.0, 401.2, 929.5, 397.5, 934.0, 393.8, 938.5, 390.2, 934.5, 386.1, 930.6, 382.0, 927.0, 379.7, 923.5, 377.3, 917.3, 373.7, 911.2, 370.0, 909.3, 370.0, 907.3, 370.0, 904.8, 372.7};
