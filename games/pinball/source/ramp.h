...
class Ramp {
    ...
    private:
        ...
        vector<float> m_ramp1 = {767.6, 169.2, 766.1, 171.5, 765.5, 174.5, 764.8, 177.5, 761.5, 187.0, 758.2, 196.5, 756.9, 204.4, 755.6, 212.2, 757.9, 214.1, 760.2, 216.0, 763.9, 216.0, 767.6, 216.0, 770.6, 213.2, 773.7, 210.5, 777.8, 201.5, 781.8, 192.5, 783.4, 186.4, 785.0, 180.2, 785.0, 177.1, 785.0, 173.9, 783.1, 171.9, 781.2, 169.8, 778.5, 168.4, 775.8, 167.0, 772.4, 167.0, 769.0, 167.0, 767.6, 169.2};
