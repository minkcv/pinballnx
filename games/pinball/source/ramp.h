...
class Ramp {
    ...
    private:
        ...
        vector<float> m_backdoorDown = {472.4, 673.4, 471.8, 674.8, 474.4, 688.5, 477.0, 702.1, 477.5, 703.1, 478.1, 704.0, 563.6, 704.0, 649.1, 704.0, 649.6, 702.5, 650.2, 701.0, 645.4, 686.8, 640.5, 672.5, 556.7, 672.2, 472.9, 672.0, 472.4, 673.4};
