...
class Ramp {
    ...
    private:
        ...
        vector<float> m_backdoorDown = {472.4, 673.4, 471.8, 674.8, 474.4, 688.5, 477.0, 702.1, 477.5, 703.1, 478.1, 704.0, 689.6, 704.0, 901.1, 704.0, 901.6, 702.6, 902.1, 701.3, 899.0, 688.9, 896.0, 676.5, 895.0, 674.2, 894.0, 672.0, 683.5, 672.0, 472.9, 672.0, 472.4, 673.4};
