...
class Ramp {
    ...
    private:
        ...
        vector<float> m_ramp1DownMid = {923.8, 357.6, 915.0, 365.2, 915.0, 366.4, 915.0, 367.5, 925.1, 379.8, 935.1, 392.0, 936.3, 392.0, 937.5, 392.0, 948.8, 383.0, 960.0, 373.9, 960.0, 372.6, 960.0, 371.3, 951.3, 363.5, 942.5, 355.6, 940.0, 353.4, 937.5, 351.1, 935.0, 350.5, 932.5, 349.9, 923.8, 357.6};
