...
class GTarget {
    ...
    private:
        ...
        vector<float> m_t = {616.4, 547.5, 615.8, 549.1, 621.0, 563.1, 626.3, 577.2, 627.7, 577.7, 629.1, 578.3, 630.3, 577.1, 631.5, 575.9, 629.2, 569.7, 627.0, 563.5, 627.0, 561.4, 627.0, 559.4, 625.8, 558.2, 624.6, 557.0, 622.5, 551.7, 620.4, 546.5, 618.7, 546.2, 617.0, 545.9, 616.4, 547.5};
