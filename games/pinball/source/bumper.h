...
class Bumper {
    ...
    private:
        ...
        vector<float> m_leftKicker = {27.0, 33.0, 27.0, 48.0, 40.5, 48.0, 54.0, 48.0, 54.0, 33.0, 54.0, 18.0, 40.5, 18.0, 27.0, 18.0, 27.0, 33.0};
        vector<float> m_rightKicker = {27.0, 639.0, 27.0, 654.0, 40.5, 654.0, 54.0, 654.0, 54.0, 639.0, 54.0, 624.0, 40.5, 624.0, 27.0, 624.0, 27.0, 639.0};
