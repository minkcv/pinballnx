...
class OptWall {
    ...
    private:
        ...
        vector<float> m_rightLock = {890.9, 498.6, 889.6, 500.2, 890.7, 501.8, 891.7, 503.5, 920.5, 503.5, 949.3, 503.5, 950.3, 501.8, 951.4, 500.2, 950.1, 498.6, 948.8, 497.0, 920.5, 497.0, 892.2, 497.0, 890.9, 498.6};
        ...
        vector<float> m_rightLockLower = {776.9, 498.6, 775.6, 500.2, 776.7, 501.8, 777.7, 503.5, 806.5, 503.5, 835.3, 503.5, 836.3, 501.8, 837.4, 500.2, 836.1, 498.6, 834.8, 497.0, 806.5, 497.0, 778.2, 497.0, 776.9, 498.6};
