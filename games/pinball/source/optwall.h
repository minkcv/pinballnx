...
class OptWall {
    ...
    private:
        ...
        vector<float> m_underLayerLock2 = {473.4, 247.4, 472.8, 248.9, 473.2, 250.7, 473.5, 252.5, 495.0, 252.5, 516.5, 252.5, 516.5, 249.5, 516.5, 246.5, 495.2, 246.2, 474.0, 246.0, 473.4, 247.4};
