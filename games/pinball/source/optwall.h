...
class OptWall {
    ...
    private:
        ...
        vector<float> m_leftRailWall2 = {1010.5, 283.9, 982.7, 312.9, 981.3, 313.5, 979.9, 314.0, 980.2, 316.7, 980.5, 319.5, 983.5, 319.8, 986.6, 320.1, 1015.0, 290.5, 1043.5, 260.9, 1043.5, 258.2, 1043.5, 255.5, 1041.0, 255.2, 1038.4, 254.9, 1010.5, 283.9};
