...
class Trigger {
    ...
    private:
        ...
        vector<float> m_lowerRightTrigger = {824.0, 505.5, 822.8, 507.0, 821.0, 507.0, 819.3, 507.0, 816.1, 508.1, 813.0, 509.2, 812.4, 511.6, 811.8, 514.0, 810.0, 516.8, 810.0, 519.6, 808.9, 520.7, 807.7, 521.9, 808.3, 523.4, 808.9, 525.0, 810.2, 525.0, 811.5, 525.0, 820.4, 516.1, 829.3, 507.2, 828.7, 505.6, 828.1, 504.0, 826.7, 504.0, 825.2, 504.0, 824.0, 505.5};
